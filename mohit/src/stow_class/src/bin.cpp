...

{
    ...
    for(int i = 0; i< rows_1; i++)
    {
        ...
        for(int k = 0; k< columns_1; k++)
        {
            ...
            for(int j = 0; j< 3; j++)
            {
                ...
                if(j == 2)
                    this->bin_1_position[i*columns_1 + k][j] = 0.0;
            }
    ...
    for(int i = 0; i< rows_2; i++)
    {
        ...
        for(int k = 0; k< columns_2; k++)
        {
            ...
            for(int j = 0; j< 3; j++)
            {
                ...
                if(j == 2)
                    this->bin_2_position[i*columns_2 + k][j] = 0.0;
            }
    ...
    {
        if(j == 1)
            this->bin_1_position_centre[j] = rack_width/2;
        if(j == 0)
            this->bin_1_position_centre[j] = rack_length_1/2;
        if(j == 2)
            this->bin_1_position_centre[j] = 0.0;
    }
    ...
    {
        if(j == 1)
            this->bin_2_position_centre[j] = rack_width/2;
        if(j == 0)
            this->bin_2_position_centre[j] = rack_length_1 + rack_length_2/2;
        if(j == 2)
            this->bin_2_position_centre[j] = 0.0;
    }
...
double* Bin_ARC_2017::set_bin_number_and_bin_location(int bin_number, int bin_position, int centre)
{
    if(centre)
    {
        switch(bin_number)
        {
        case  1:
            return this->bin_1_position_centre;

        case 2:
            return this->bin_2_position_centre;
        }
    }
