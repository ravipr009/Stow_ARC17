...
int main(int argc, char** argv)
{
    ...
    while(1)
    {
        ...
        if(choice == 'm')
        {
            ...
            myfile.open ("/home/mohit/Desktop/ros_ws/src/caliberation/data_files/marker_coordinates.txt", std::ios::out);

            std::cout <<"press 's' to store marker coordinates or 'b' to exit\n";

            while(1)
            {
                reference_point_wrt_tip_link.header.frame_id = "tip";
                ...
                if(choice == 's')
                {
                    ...
                    listener.waitForTransform( "world", "tip", ros::Time(0), ros::Duration(3));
        ...
        if(choice == 'j')
        {
            myfile.open ("/home/mohit/Desktop/ros_ws/src/caliberation/data_files/joint_angles.txt", std::ios::out);
