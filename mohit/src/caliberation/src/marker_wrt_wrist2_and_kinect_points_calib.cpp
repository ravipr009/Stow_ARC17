...
int main(int argc, char** argv)
{
    ...
    myfile.open ("/home/mohit/Desktop/ros_ws/src/caliberation/data_files/joint_angles.txt", std::ios::in);
    ...
    myfile.open("/home/mohit/Desktop/ros_ws/src/caliberation/data_files/marker_coordinates.txt", std::ios::in);
    ...
    myfile3.open("/home/mohit/Desktop/ros_ws/src/caliberation/data_files/marker_coordinates_wrt_kinect.txt", std::ios::out);

    std::fstream myfile4;

    myfile4.open("/home/mohit/Desktop/ros_ws/src/caliberation/data_files/marker_coordinates_wrt_ee_link.txt", std::ios::out);
